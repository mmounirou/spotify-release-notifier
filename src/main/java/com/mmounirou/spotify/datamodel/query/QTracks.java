...
public class QTracks extends com.mysema.query.sql.RelationalPathBase<Tracks> {
    ...
    private static final long serialVersionUID = -1411955634;

    public static final QTracks tTracks = new QTracks("t_tracks");

    public final StringPath name = createString("name");

    public final StringPath trackalbum = createString("trackalbum");

    public final StringPath trackartist = createString("trackartist");
